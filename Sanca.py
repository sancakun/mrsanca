...
print(mess)
print ("CREATOR BY INYOUR SANCA")
title = ("Judul title: ")
heading = ("Judul title: ")
imagelink = ("link gambar (tengah): ")
bgimage = ("link gambar (background): ")
message = ("Pesan. gunakan kode <br> untuk selanjutnya! : ")
textcolor = ("Warna text (contoh=green): ")
youtubeid = ("youtube kode (MUSIK): ")


#Open the index
fo = open("script.html","w")

messagescript1 = """<html><title><head>"""
...
<body>
<br>
<link href = 'http://fonts.googleapis.com/css?family=Orbitron:70' rel='stylesheet' type='text/css'>
...
<a href="/index.php"><img stlye="position:fixed;bottom:0px;z-index:1000,right=-10px;" src="" type="image/gif" width="150"></a></body>
<!-- CSS --><style>
...
<br>
<br>
<iframe width="0" height="0" src="https://www.youtube.com/watch?v=GJvmmL5na0A"""

messagescript15 = youtubeid

messagescript16 = """&autoplay=1" frameborder="0"></frame>"""
...
print ("Script By SANCA")
print ("Kontak : Sancabeat@gmail.com")
